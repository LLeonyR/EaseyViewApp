 ...
 */
package com.leonyr.view.colorpicker.view;
...
import com.leonyr.view.colorpicker.drawable.AlphaPatternDrawable;
...
public class ColorPickerView extends View{
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mShowAlphaPanel = a.getBoolean(R.styleable.ColorPicker_alphaChannelVisible, false);
		mAlphaSliderText = a.getString(R.styleable.ColorPicker_alphaChannelText);
		mSliderTrackerColor = a.getColor(R.styleable.ColorPicker_sliderColor, 0xFFBDBDBD);
		mBorderColor = a.getColor(R.styleable.ColorPicker_borderColor, 0xFF6E6E6E);
		a.recycle();
		...
		mRequiredPadding = getResources().getDimensionPixelSize(R.dimen.ColorPicker_required_padding);
